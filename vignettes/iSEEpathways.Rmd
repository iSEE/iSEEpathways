---
title: "Introduction to iSEEpathways"
author: 
...
vignette: >
  %\VignetteIndexEntry{Introduction to iSEEpathways}
...
`r Biocpkg("iSEEpathways")` is based on many other packages and in particular in those that have implemented the infrastructure needed for dealing with omics data and interactive visualisation.
...
We hope that `r Biocpkg("iSEEpathways")` will be useful for your research. Please use the following information to cite the package and the overall approach. Thank you!
...
app <- iSEE(se, initial = list(
  PathwaysTable(ResultName="fgsea", Selected = "GO:0046324", PanelWidth = 6L),
  FgseaEnrichmentPlot(ResultName="fgsea", PathwayId = "GO:0046324", PanelWidth = 6L)
))
